...
export class addsController implements Controller {
    ...
    private initializeRoutes() {
        this.router.post('/adds', this.GpCreate);
this.router.get('/adds/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
    }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.SCREENSURL + `${req.url}` , req.body)
...
public GpGetNounCreatedBy(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.SCREENSURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
